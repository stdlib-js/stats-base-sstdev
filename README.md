...
```javascript
sstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdev@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-sstdev/tags). For example,

```javascript
sstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdev@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sstdev = require( 'path/to/vendor/umd/stats-base-sstdev/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdev@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-sstdev.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-sstdev

[test-image]: https://github.com/stdlib-js/stats-base-sstdev/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-sstdev/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-sstdev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-sstdev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-sstdev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-sstdev/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-sstdev/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-sstdev/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-sstdev/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-sstdev/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-sstdev/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-sstdev/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-sstdev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-sstdev/main/LICENSE
